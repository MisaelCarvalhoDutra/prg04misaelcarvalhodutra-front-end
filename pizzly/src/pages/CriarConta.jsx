...
export default function CriarConta() {
  ...
  // Envio do formulário e solicitação do código
  ...
  // Validação do código e criação da conta
  ...
  return (
    <div className="lp-root">
      ...
      <div className="lp-main">
        ...
        {/* Coluna esquerda: apresentação da marca - painel vermelho */}
        ...
        {/* Coluna direita: formulário de cadastro - parte branca*/}
